import { View, Text, ImageBackground, Image, TouchableOpacity, ScrollView, TextInput, StatusBar } from 'react-native'
import React from 'react'

const Seven = ({ navigation }) => {

    const Goo = () => {
        navigation.navigate("eightt")

    }

    return (
        <View style={{ flex: 1 }}>
            <ImageBackground source={require("../config/images/sixx.png")} style={{ width: "100%", height: "100%" }}>
                <StatusBar backgroundColor="#C80033" />
                ...
                <ScrollView>
                    ...
                    <View style={{ backgroundColor: "white", width: 310, height: 70, borderRadius: 15, alignSelf: "center", marginTop: 40, opacity: .4 }}>

                    </View>
                    <View style={{ position: "absolute", top: 262, right: 100 }} >
                        <TouchableOpacity onPress={Goo}>
                    ...
                    <View style={{ backgroundColor: "white", width: 310, height: 70, borderRadius: 15, alignSelf: "center", marginTop: 25, opacity: .4 }}>
