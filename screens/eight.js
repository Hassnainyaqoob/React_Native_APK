import { View, Text, StatusBar, ImageBackground, Image, ScrollView, TouchableOpacity } from 'react-native'
import React from 'react'

const Eight = ({ navigation }) => {

    const NextGo = () => {
        navigation.navigate("ninee")
    }

    return (
        <View style={{ flex: 1 }}>
            <ImageBackground source={require("../config/images/seven.png")} style={{ width: "100%", height: "100%" }}>
                ...
                <ScrollView>
                    ...
                    <View style={{ backgroundColor: "white", width: 310, height: 70, borderRadius: 15, alignSelf: "center", marginTop: 40, opacity: .5 }}>

                    </View>
                    <View style={{ position: "absolute", top: 262, right: 100 }} >
                        <TouchableOpacity onPress={NextGo}>
                    ...
                    <View style={{ backgroundColor: "white", width: 310, height: 70, borderRadius: 15, alignSelf: "center", marginTop: 25, opacity: .5 }}>
